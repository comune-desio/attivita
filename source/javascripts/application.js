(function() {
  ...
  function updateList() {
    ...
    var mapped = visibleFeatures.map(function(el, i) {
      return { index: i, value: el.properties.title.toLowerCase() };
    })
    mapped.sort(function(a, b) {
      return +(a.value > b.value) || +(a.value === b.value) - 1;
    });
    var sortedFeatures = mapped.map(function(el){
      return visibleFeatures[el.index];
    });

    resultsContainer.innerHTML = "";
    for (var index = 0; index < sortedFeatures.length; ++index) {
      var feature = sortedFeatures[index];
  ...
  function initMap() {
    ...
    var datasetUrl = "https://raw.githubusercontent.com/comune-desio/opendata_attivita/build/bundle.geojson";
